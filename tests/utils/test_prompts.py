...
class TestPrompts(unittest.TestCase):
    ...
    def test_get_module_prompt(self):
        ...
        result = Prompts.make_prompt('openssm.core.slm.base_slm', 'completion')
        ...
        result = Prompts.make_prompt('openssm.core.slm.test_prompt', 'instruction')
        expected = "This is a test instruction."
        self.assertEqual(result, expected)

        # Test case 3: Fetching another new test prompt
        result = Prompts.make_prompt('openssm.core.other_module.other_subindex', 'message')
        ...
        with self.assertRaises(ValueError):
            Prompts.make_prompt("openssm.core.slm.no_such_module")

        # Test case 6: Fetching a prompt that does not exist (invalid subindex)
        with self.assertRaises(ValueError):
            Prompts.make_prompt("openssm.core.slm.base_slm", "non_existent_subindex")
